...
public class GUI extends JFrame implements ActionListener {
    ...
    public static void main(String[] args)
    {
      ...
      String database_name = "team_9c_db";
      String database_user = "team_9c";
      ...
      try{
        ...
        // Change SQL command to a relevant query that retrieves a small amount of data
        String sqlStatement = "SELECT student_name FROM teammembers;"; // DONE
